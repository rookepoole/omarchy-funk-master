...
This restores the snapshot from the most recent installation or screensaver upgrade, including the previous theme, wallpaper link, bar configuration, branding, existing Funk Master files (if any), the idle clone, and screensaver toggle. To select an older snapshot:
...
See [design research](docs/design-research.md), [wallpaper prompt and provenance](docs/wallpaper-prompt.md), [initial desktop validation](docs/validation.md), and [ASCII screensaver usage and validation](docs/screensavers.md).
